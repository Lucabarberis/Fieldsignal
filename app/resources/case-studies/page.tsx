...
export default function CaseStudiesHubPage() {
  ...
  const howNum = String(published.length + 1).padStart(2, "0");
  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-9">
        <TileGrid cols={3}>
          <Tile id={`${howNum}.1`} name="ANONYMISED COMPOSITES">
            <p>
          ...
          <Tile id={`${howNum}.2`} name="SCREENED & MEASURED">
            <p>
          ...
          <Tile id={`${howNum}.3`} name="SAME STANDARD, ANY SIZE">
            <p>
